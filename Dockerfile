...
# Add a new user 'appuser' with home directory /home/appuser
RUN addgroup -S appgroup && adduser -S appuser -G appgroup

# Set the working directory
WORKDIR /src/app

# Copy package.json and package-lock.json and install dependencies as root
COPY package*.json ./
RUN npm install
...
# Copy the rest of the application code and ensure correct ownership
